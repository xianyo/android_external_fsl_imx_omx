...
static void convertISO8859ToString8(
 ...
 // the 2nd argument is used to get the data following the \0 in a comment fie    ld
...
// comment fields (COM/COMM) contain an initial short descriptor, followed by     \0,
 // followed by more data. The data following the \0 can be retrieved by setti    ng
// "otherdata" to true.
