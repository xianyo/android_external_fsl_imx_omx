...
sed -i "s/Package:                   android_L5.0.0_1.0.0-20150309_omxplayer_source.tar/Package:                   $1_omxplayer_source.tar.gz/g" SCR-omxplayer.txt 

DATE=`date +%Y-%b-%d`
sed -i "s/Date Created:              2015-Mar-12/Date Created:              $DATE/g" SCR-omxplayer.txt
...
tar czf $1_omxplayer_source.tar.gz external/fsl_imx_omx device/fsl-codec clean_obj_before_building.sh switch_build_to.sh EULA.txt SCR-omxplayer.txt omxplayer_package_manifest.txt
