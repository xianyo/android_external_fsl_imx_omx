   ...
   protected void onResume() {
    ...
    protected void onPause() {
        ...
        if(mPlayState == PLAYER_PLAYING){
            ...
            // this shall be avoided. so , save a flag here, check it in surfaceChanged and onPrepared
    ...
    SurfaceHolder.Callback mSHCallback = new SurfaceHolder.Callback(){
        public void surfaceChanged(SurfaceHolder holder, int format,
            int w, int h){
            Log.d(TAG,"surfaceChanged:" + mSurfaceWidth + "," + mSurfaceHeight + ",mPlayState:" + mPlayState + " mTargetState:" + mTargetState);
            mSurfaceWidth = w;
            mSurfaceHeight = h;
            ...
            if(mMediaPlayer != null && hasValidSize && mPlayState != PLAYER_STOPPED) {
                start();
                if(mTargetState == PLAYER_PAUSED){
                    pause();
